...
class Hand(object):
    ...
    def update(self, word):
        ...
        old_hand = self.handDict.copy()
        for letter in old_hand:
            self.handDict[letter] -= word_freq.get(letter, 0)
    ...
    def __eq__(self, other):
        ...
        """
        return type(other) == Hand and self.handDict == other.handDict
    ...
    def __str__(self):
        ...
        return string
        #return ''.join(c for c in self.handDict for i in range(self.handDict[c]))
